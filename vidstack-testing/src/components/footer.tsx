...
const Footer = () => {
    return (
        <>
        <footer className="bg-background-light mt-8 mb-8 md:mb-0">
            <div className="flex flex-col md:flex-row-reverse md:justify-between space-y-6 md:space-y-0 text-center md:text-left text-sm lg:text-base container xl:max-w-7xl mx-auto px-4 py-8">
                ...
                <nav className="space-x-2 sm:space-x-4">
                    <Link href="/about" className="font-medium text-gray-400 hover:text-main transition-all duration-200"> About </Link>
                    <Link href="/tos" className="font-medium text-gray-400 hover:text-main transition-all duration-200"> Terms of Service </Link>
                    <Link href="/dmca" className="font-medium text-gray-400 hover:text-main transition-all duration-200"> DMCA </Link>
                </nav>
